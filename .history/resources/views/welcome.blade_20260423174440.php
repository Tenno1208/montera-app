...
<body class="bg-gray-50">
    ...
    <div class="max-w-md mx-auto min-h-screen relative pb-24">
        ...
        <div class="px-6">
            <div class="luxury-card p-8 rounded-[2.5rem] shadow-2xl shadow-red-900/20 text-white relative overflow-hidden">
                <div class="relative z-10">
                    ...
                    <h2 class="text-3xl font-bold mt-1">Rp 12.450.000</h2>
                    <div class="mt-8 flex justify-between">
                        <div>
                            <p class="text-[10px] uppercase opacity-50">Income</p>
                            <p class="text-sm font-semibold text-green-400">+Rp 8.0M</p>
                        </div>
                        <div class="text-right">
                            <p class="text-[10px] uppercase opacity-50">Expense</p>
                            <p class="text-sm font-semibold text-red-400">-Rp 2.1M</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="mt-10 px-6">
            ...
            <div class="space-y-4">
                <div class="bg-white p-4 rounded-[1.5rem] flex items-center shadow-sm hover:shadow-md transition-all">
                    <div class="w-12 h-12 bg-black rounded-2xl flex items-center justify-center text-white mr-4">
                        <i class="fa-solid fa-utensils"></i>
                    </div>
                    <div class="flex-1">
                        <p class="font-bold text-sm text-gray-900">Fine Dining</p>
                        <p class="text-[10px] text-gray-400 uppercase">12 Apr • Food</p>
                    </div>
                    <p class="font-bold text-red-600 text-sm">- Rp 850k</p>
                </div>
            </div>
        </div>
