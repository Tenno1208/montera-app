    ...
    try {
        ...
        $response = Http::post("https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key={$apiKey}", [
            'contents' => [
                [
                    'parts' => [
                        ['text' => 'Analisa struk ini. Berikan hasil dalam format JSON MURNI: {"title": "nama toko", "amount": 10000, "category": "makanan", "date": "YYYY-MM-DD"}. Jangan beri penjelasan apapun, hanya JSON.'],
