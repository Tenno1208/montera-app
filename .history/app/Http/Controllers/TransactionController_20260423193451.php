...
public function scanNota(Request $request)
{
    ...
    try {
        ...
        $response = Http::post("https://generativelanguage.googleapis.com/v1beta/models/gemini-pro-vision:generateContent?key={$apiKey}", [
        'contents' => [
            [
                'parts' => [
                    ['text' => 'Analisa foto nota ini dan berikan JSON: {"title": "nama toko", "amount": 10000, "category": "makanan", "date": "YYYY-MM-DD"}'],
