...
<div style="padding: 25px;">
    ...
    <div style="display: flex; flex-direction: column; gap: 15px;">
        ...
        <div style="background: linear-gradient(135deg, #D32F2F, #7B1111); padding: 25px; border-radius: 30px; margin-top: 20px; text-align: center;">
            ...
            <a href="https://wa.me/6281334891651" style="display: block; background: white; color: black; padding: 12px; border-radius: 15px; text-decoration: none; font-weight: 900; font-size: 0.8rem;">HUBUNGI WHATSAPP</a>
        </div>
    </div>
</div>
@endsection